...
public class Server{
    ...
    public void receive(Message msg) throws JMSException {
   	 ...
   	 if ( msg.getJMSType() != null && msg.getJMSType().equals("register") ) {
   		 ...
   		 try{
   			 ...
   			 template.convertAndSend(msg.getJMSReplyTo(), "ERROR while Registering: "+e.getMessage() );
   		 }
   	 ...
   	 //receive createChatRoom msg
   	 else if (msg.getJMSType() != null && msg.getJMSType().equals("ccr") ) {
    ...
    public void createChatroom(Destination dest,  String username, String msg) {
   	 ...
   	 if (msg.equals("") ) {
   		 ...
   		 chatrooms.put(newRoomID, newRoom);
   	 ...
   	 // make a room w/ specified name
   		 ...
   		 if (chatrooms.containsKey(newRoomID) ) {
   			 ...
   			 template.convertAndSend(dest, failCreate);
   			 return;
   		 }
   		 // put new room into hashmap
   		 chatrooms.put(newRoomID, newRoom);
